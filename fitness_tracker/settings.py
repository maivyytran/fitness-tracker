...
SECRET_KEY = 'django-insecure-c+&pebh3deb(&oqw@y%_5#2-jtyw#-2zxkos$@)g5ahl9_h_%='

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['*']
CSRF_TRUSTED_ORIGINS = ['https://web-production-f731e.up.railway.app']
...
DATABASES = {
    'default': {
        ...
        'NAME': 'retool',
        'USER': 'retool',
        'PASSWORD': 'npg_Hb6BvO8yPgDw',
        'HOST': 'ep-bold-morning-aksy2bj3-pooler.c-3.us-west-2.retooldb.com',
        'PORT': '5432',
        'OPTIONS': {
            'sslmode': 'require',
        },
