...
SECRET_KEY = "django-insecure-oallya4x8ky5@c+ysr1%%$%$+41^7@+*t&t3=o-=@gi5xw#d2@"
...
TEMPLATES = [
    {
        ...
        "DIRS": ['/home/maivytran/fitness_tracker/fitness_tracker/templates'],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
MEDIA_ROOT = '/home/maivytran/fitness_tracker/media'
MEDIA_URL = '/media/'
STATIC_ROOT = '/home/maivytran/fitness_tracker/static'
STATIC_URL = '/static/'
LOGIN_REDIRECT_URL = '/'
